...
\affiliation{Bates College; Core team member}

\correspondingauthor{Jeffrey S. Oishi}
\email{joishi@bates.edu}

\author{Benjamin P. Brown}
\affiliation{University of Colorado, Boulder; Core team member}
\author{Keaton J. Burns}
\affiliation{MIT; Core team member}
\author{Daniel Lecoanet}
\affiliation{Princeton; Core team member}
\author{Geoffrey M. Vasil}
\affiliation{University of Sydney; Core team member}
...
%  LocalWords:  miniconda datasets middleware frontends Jupyter
%  LocalWords:  Shifter
